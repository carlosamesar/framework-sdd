...
updated: "2026-04-10"
closed: "2026-04-10"
source_archive: "openspec/changes/archive/2026-04-08-admin-transactions-saga-expansion"
implements:
...
> **Nota:** `openspec/specs/saga/spec.md` documenta otro ámbito (certificación SAGA NestJS). Este archivo es la **fuente de verdad aprobada** para tipos administrativos en el orquestador Lambda unificado.
...
## Notas de implementación (cierre)

- **Contabilidad:** implementada vía lambda de asiento (`fnAsientoContable`); env `LAMBDA_FN_CONTABILIDAD` tiene prioridad sobre `LAMBDA_FN_ASIENTO_CONTABLE`.
- **Orden de pasos:** el asiento se ejecuta al final del flujo del orquestador en la versión desplegada; el guard por tipo cumple omisión/ejecución contable.
- **Evidencia:** ver `openspec/changes/archive/2026-04-08-admin-transactions-saga-expansion/CIERRE-SPEC.md`.
